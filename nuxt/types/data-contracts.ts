...
export interface SmsRoutingPlansRulesUpdatePayload {
  ...
  is_active?: boolean;
  priority?: number;
  action: "send" | "split" | "drop" | "filter";
  action_vars?: string | null;
}

export type SmsRoutingPlansRulesDeletePayload = object;

export interface SmsRoutingPlansRulesSplitCreatePayload {
  country_id?: number;
  network_id?: number;
  is_active?: boolean;
  priority?: number;
...
export interface SmsRoutingPlansRulesSplitUpdatePayload {
  country_id?: number;
  network_id?: number;
  is_active?: boolean;
  priority?: number;
...
export interface SmsRoutingPlansSimulateCreatePayload {
  country_id: number;
  network_id?: number;
  /** @min 0 */
  counter?: number;
