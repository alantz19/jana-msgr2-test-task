...
>
    <div x-data="{offerSelect: 1}">
        ...
        <div x-show="offerSelect === 1">
            @livewire('campaign-send.new-offer-form.create-offer', ['campaign_id' => $this->smsCampaign->id])
        </div>
        <div x-show="offerSelect === 2">
            abc
        </div>
        <div class="mt-9">
            @livewire('campaign-send.new-offer-form.offer-list', ['campaign_id' => $this->smsCampaign->id])
        </div>
