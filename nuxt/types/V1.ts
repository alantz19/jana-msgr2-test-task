...
import {
  ...
  SmsRoutingPlansRulesSplitCreatePayload,
  SmsRoutingPlansRulesSplitUpdatePayload,
  SmsRoutingPlansRulesUpdatePayload,
  SmsRoutingPlansSimulateCreatePayload,
...
export class V1<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags SmsRoutingPlanRules
   * @name SmsRoutingPlansRulesSplitCreate
   * @request POST:/v1/sms/routing/plans/{plan}/rules/split
   */
  smsRoutingPlansRulesSplitCreate = (
    plan: number,
    data: SmsRoutingPlansRulesSplitCreatePayload,
    params: RequestParams = {},
  ) =>
    this.request<
      SmsRoutingPlanRuleResource,
    ...
    >({
      path: `/v1/sms/routing/plans/${plan}/rules/split`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      format: "json",
   ...
   *
   * @tags SmsRoutingPlanRules
   * @name SmsRoutingPlansRulesSplitUpdate
   * @request PUT:/v1/sms/routing/plans/{plan}/rules/{rule}/split
   */
  smsRoutingPlansRulesSplitUpdate = (
    plan: number,
    rule: number,
    data: SmsRoutingPlansRulesSplitUpdatePayload,
    params: RequestParams = {},
  ) =>
    this.request<
      SmsRoutingPlanRuleResource,
    ...
    >({
      path: `/v1/sms/routing/plans/${plan}/rules/${rule}/split`,
      method: "PUT",
      body: data,
      type: ContentType.Json,
      format: "json",
   ...
   *
   * @tags SmsRoutingPlanRules
   * @name SmsRoutingPlansSimulateCreate
   * @request POST:/v1/sms/routing/plans/{plan}/simulate
   */
  smsRoutingPlansSimulateCreate = (
    plan: number,
    data: SmsRoutingPlansSimulateCreatePayload,
    params: RequestParams = {},
  ) =>
    this.request<
      {
    ...
    >({
      path: `/v1/sms/routing/plans/${plan}/simulate`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      format: "json",
