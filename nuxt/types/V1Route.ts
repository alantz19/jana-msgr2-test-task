...
export namespace V1 {
   ...
   */
  export namespace SmsRoutingPlansRulesSplitCreate {
    export type RequestParams = {
      /** The plan ID */
      plan: number;
    };
    export type RequestQuery = {};
    export type RequestBody = SmsRoutingPlansRulesSplitCreatePayload;
    export type RequestHeaders = {};
    export type ResponseBody = SmsRoutingPlanRuleResource;
  }
   ...
   */
  export namespace SmsRoutingPlansRulesSplitUpdate {
    export type RequestParams = {
      /** The plan ID */
      plan: number;
      /** The rule ID */
    ...
    export type RequestQuery = {};
    export type RequestBody = SmsRoutingPlansRulesSplitUpdatePayload;
    export type RequestHeaders = {};
    export type ResponseBody = SmsRoutingPlanRuleResource;
  }
   ...
   */
  export namespace SmsRoutingPlansSimulateCreate {
    export type RequestParams = {
      /** The plan ID */
      plan: number;
    };
    export type RequestQuery = {};
    export type RequestBody = SmsRoutingPlansSimulateCreatePayload;
    export type RequestHeaders = {};
    export type ResponseBody = {
      status: string;
